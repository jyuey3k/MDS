...
plot(hclust(data.dist), labels=labs, main="Complete Linkage", xlab="", sub="",ylab="", cex=0.01)
plot(hclust(data.dist, method="average"), labels=labs, main="Average Linkage", xlab="", sub="",ylab="", cex=0.01)
plot(hclust(data.dist, method="single"), labels=labs,  main="Single Linkage", xlab="", sub="",ylab="", cex=0.01)
hc.out=hclust(data.dist)
hc.clusters = cutree(hc.out, k = 5)
table(hc.clusters)
@
\begin{cBox}
